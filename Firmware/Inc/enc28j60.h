...
//#define 	ENC28J60_CS	 		HAL_GPIO //GPIO_Pin_4

#define 	ENC28J60_CSL()		HAL_GPIO_WritePin(CS_GPIO_Port, CS_Pin, GPIO_PIN_RESET); //(GPIOD->ODR &= ~(1<<9))//GPIOA->BRR = ENC28J60_CS;
#define 	ENC28J60_CSH()		HAL_GPIO_WritePin(CS_GPIO_Port, CS_Pin, GPIO_PIN_SET); //(GPIOD->ODR |= 1<<9)//GPIOA->BSRR = ENC28J60_CS;
